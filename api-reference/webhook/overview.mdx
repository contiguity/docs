...
<Note>
    As of November 1st, 2024, webhook endpoints must be secured with HTTPS to protect sensitive data, like Identity verification reports. See [Webhook Signing](/api-reference/webhook/signing) to verify payloads with HMAC-SHA256.
</Note>
