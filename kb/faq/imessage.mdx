...
<AccordionGroup>
  ...
  <Accordion title="What can get my number flagged or restricted?" icon="ban">
    There's no carrier-side content filtering for iMessage, but Apple watches for sending patterns that look automated. Identical broadcasts, high volume to brand-new contacts, fixed sending intervals, and ignored opt-outs are the biggest risk factors. See our [iMessage best practices](/kb/compliance/imessage/best-practices) for how to keep your number healthy.
  </Accordion>
