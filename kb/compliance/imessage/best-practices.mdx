...
Whether you or the customer sends the first message in a conversation is the single biggest factor in how risky your sending looks to Apple. See [Strategies](/kb/compliance/imessage/strategies/overview) for a full breakdown of inbound-first, outbound-first, and hybrid approaches, with pros, cons, and code examples.
